date: 2007-11-08
slug: if-you-love-your-users-set-them-free
...
`` rel="next" `` or `` rel="me next" ``? [lab.backnetwork](http://lab.backnetwork.com/xfnpagination/) uses `` rel="next" `` but [microformats.org](http://microformats.org/wiki/hcard-xfn-supporting-friends-lists#Implement_hCard_XFN_supporting_friends_lists) recommends `` rel="me next" ``.
