excerpt: 'This weekend I started experimenting with Jeff Forcier''s Releases library.
  Releases is a Sphinx extension  that makes it pretty easy to maintain the changelog
  for a python library (or anything you can write  Sphinx docs for).
